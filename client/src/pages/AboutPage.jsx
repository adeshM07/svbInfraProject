  ...
  return (
    <>
      ...
      <div>
        ...
        >
          <div className="pl-[30px] [@media(min-width:300px)_and_(max-width:700px)]:pt-[50px] [@media(min-width:800px)_and_(max-width:1200px)]:pt-[60px] pt-[100px] lg:pl-[120px] lg:pt-[150px]">
            <motion.p
