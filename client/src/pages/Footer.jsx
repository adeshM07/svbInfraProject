  ...
  return (
    <>
      <div className="bg-[#F8F8F8] w-full">
        ...
        >
          <div className=" lg:h-[65%] flex flex-col [@media(min-width:800px)_and_(max-width:1200px)]:pl-4 pl-4 md:pl-0 lg:flex-row justify-evenly pt-10 lg:pt-20 gap-8 lg:gap-40">
            <div className="flex flex-col gap-7">
              <img
                src={logo}
                className="[@media(min-width:800px)_and_(max-width:1200px)]:w-[12vw] [@media(min-width:800px)_and_(max-width:1200px)]:h-[10vh] w-[20vw] h-[5vh] lg:w-[9vw] lg:h-[8vh]  lg:mx-0"
              />
          ...
          <div className=" lg:h-[35%] flex flex-col gap-4 place-items-center justify-center">
            <div className="flex gap-2  lg:mt-0">
              ...
              >
                <img
                  src={fb}
                  className="[@media(min-width:800px)_and_(max-width:1200px)]:h-[7vh]  h-[3vh] lg:h-[4vh] cursor-pointer"
                  alt="Facebook"
                />
              </a>
            ...
            <p className="text-white popins [@media(min-width:800px)_and_(max-width:1200px)]:text-[1rem] text-[0.5rem] lg:text-[0.8rem] mb-4 lg:mb-0">
