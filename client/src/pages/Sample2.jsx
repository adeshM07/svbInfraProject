  ...
  return (
    <header
      className={`
        ...
        ${isAtTop && !open ? "bg-transparent" : "bg-[#333333] shadow-lg"}
      `}
    >
      <section as="nav" className="py-6 text-white mx-auto
        ...
        <ul className="hidden lg:flex gap-7 font-medium text-white">
          ...
          <NavLink className="text-lg font-semibold" to="/fleet">Our Fleet</NavLink>
