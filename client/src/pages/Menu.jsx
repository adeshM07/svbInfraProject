...
const Menu = () => {
  ...
  return (
    <>
      <div
        className={`
    fixed top-0 left-0  [@media(min-width:750px)_and_(max-width:1200px)]:h-[15vh] w-full flex px-5 md:px-6 justify-between 
      ...
      >
        <div className="">
          <Link to="/">
            <img
              src={svbLogo}
              className="w-[15vw] h-[5vh] [@media(min-width:750px)_and_(max-width:1200px)]:h-[9vh] [@media(min-width:750px)_and_(max-width:1200px)]:w-[7vw] lg:w-[8vw] xl:w-[8vw] xl:h-[8vh] lg:h-[8vh]"
            />
          </Link>
        </div>
        {popup && (
