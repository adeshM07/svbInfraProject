...
const Menu = () => {
  ...
  return (
    <>
      <div
        className={`
    fixed top-0 left-0  [@media(min-width:900px)_and_(max-width:1200px)]:h-[13vh] w-full flex px-5 md:px-6 justify-between 
      ...
      >
        <div className="">
          <Link to="/">
            <img
              src={svbLogo}
              className="w-[15vw] h-[5vh] [@media(min-width:900px)_and_(max-width:1200px)]:h-[9vh] [@media(min-width:900px)_and_(max-width:1200px)]:w-[7vw] lg:w-[8vw] xl:w-[8vw] xl:h-[8vh] lg:h-[8vh]"
            />
          </Link>
        </div>
        {popup && (
  ...
  z-[999]"
        ...
        {isMobile ? (
          ...
          <>
            ...
            <Link to="/contact">
              <button
                className="menuButton [@media(min-width:900px)_and_(max-width:1200px)]:h-[8vh] md:w-[15vw] md:h-[4vh] w-[9vw] h-[6vh] lg:h-[6vh] lg:w-[9vw] bg-[#FDC000] text-black text-[1rem] rounded-[9px] transition duration-300 transform
