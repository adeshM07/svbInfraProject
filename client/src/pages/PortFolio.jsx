              ...
              <div className="relative   lg:mx-0  lg:ml-[60px]  overflow-hidden  rounded-xl flex gap-2 lg:gap-[40px] py-4">
                {[onc1, c3].map((src, index) => (
                  <img
                    ...
                    src={src}
                    alt={`Project ${index + 1}`}
                    className="w-[30vw] h-[20vh] [@media(min-width:650px)_and_(max-width:1200px)]:h-[60vh] [@media(min-width:1400px)_and_(max-width:1500px)]:w-[22vw] [@media(min-width:1400px)_and_(max-width:1500px)]:h-[40vh]   xl:w-[20vw] xl:h-[50vh] 2xl:w-[18vw] lg:w-[18vw] lg:h-[47vh] 2xl:h-[47vh] lg:object-cover rounded-lg "
                  />
                ))}
              </div>
            </motion.div>
