...
const PortFolio = () => {
  ...
  return (
    <>
      ...
      <div className="flex  flex-col gap-10 lg:gap-[13vh] my-10 lg:my-30 ">
        ...
        <section className="px-2.5 md:px-8 lg:px-15 xl:px-30 flex flex-col gap-12 overflow-hidden ">
          ...
          <div className="relative   w-full overflow-hidden  rounded-xl flex gap-[30px]  md:gap-[40px] py-4">
            {[
              c1,
              c2,
              c3,
              ...
              <img
                ...
                className="animate-cardScroll w-[33vw] h-[20vh] 
              sm:min-w-[170px] sm:h-fit
              md:min-w-[240px] md:h-fit
              lg:min-w-[230px] lg:fit
              xl:min-w-[240px] xl:h-fit
