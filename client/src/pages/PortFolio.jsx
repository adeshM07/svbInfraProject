    ...
    <>
      ...
      <div className="flex  flex-col gap-10 lg:gap-[13vh] py-10 lg:py-30 bg-[#F8F8F8]">
        <section className="flex  flex-col gap-8 lg:gap-8">
          ...
          {/* ===== Content Section ===== */}
          <div className="flex flex-col  lg:flex-row lg:w-fit lg:gap-30 xl:gap-10 2xl:gap-30 mx-4 lg:mx-auto [@media(min-width:2500px)]:w-[19vw]gap-50">
              ...
              <div className="relative   lg:mx-0  lg:ml-[60px]  overflow-hidden  rounded-xl flex gap-2 lg:gap-[40px] py-4">
                {[onc1, c3].map((src, index) => (
                  <img
                    ...
                    src={src}
                    alt={`Project ${index + 1}`}
                    className="w-[30vw] h-[20vh] [@media(min-width:650px)_and_(max-width:1200px)]:h-[60vh] [@media(min-width:1400px)_and_(max-width:1500px)]:w-[22vw] [@media(min-width:1400px)_and_(max-width:1500px)]:h-[40vh]   xl:w-[20vw] xl:h-[50vh] 2xl:w-[18vw] lg:w-[18vw] lg:h-[47vh] 2xl:h-[47vh] lg:object-cover rounded-lg [@media(min-width:2500px)]:w-[19vw]"
                  />
                ))}
              </div>
            </motion.div>
          ...
          <div className="relative   w-[92vw] mx-auto lg:mx-0 lg:w-[92vw] lg:ml-[60px] lg:mr-[60px] overflow-hidden  rounded-xl flex gap-2 lg:gap-[40px] py-4">
            {[
              ...
              <img
                ...
                src={src}
                alt={`Project ${index + 1}`}
                className="w-[30vw] [@media(min-width:650px)_and_(max-width:1200px)]:h-[60vh]   h-[20vh] lg:w-[18vw] xl:w-[22vw] 2xl:w-[18vw] lg:h-[47vh] lg:object-cover rounded-lg animate-cardScroll"
              />
            ))}
          </div>
        </section>
