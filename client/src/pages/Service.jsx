  ...
  return (
    <>
      ...
      <div className="w-screen">
        ...
        <div
          id="serviceBanner"
          className="w-screen [@media(min-width:650px)_and_(max-width:1200px)]:h-[100vh]  h-[45vh] md:h-[45vh] lg:h-[95vh] xl:h-[95vh]"
        >
            ...
            {[s1, s2, s3, s4].map((src, index) => (
              ...
              >
                ...
                >
                  <img
                    src={src}
                    className="w-[23vw] h-[13vh] [@media(min-width:650px)_and_(max-width:1200px)]:w-[19vw] [@media(min-width:650px)_and_(max-width:1200px)]:h-[40vh]  [@media(min-width:300px)_and_(max-width:410px)]:h-[17vh] [@media(min-width:300px)_and_(max-width:410px)]:w-[24vw]  md:h-[20vh] lg:w-[20vw] xl:w-[20vw] 2xl:w-[18vw] 2xl:h-[47vh]   lg:h-[47vh] xl:h-[52vh] xl:w-[24vw] object-cover 
