  ...
  return (
    <>
      ...
      <div className="bg-[F8F8F8]">
        ...
        {isMobile ? (
          ...
          >
            <div className="flex animate-scroll  gap-[2px] lg:gap-[24px] min-w-full">
              <img
                src={c1}
                className="max-w-[47vw]  max-h-[30vh] lg:w-[18vw] lg:h-[47vh] flex-shrink-0 scale-3d"
              />
              <img
                src={c2}
        ...
        <div className="  mx-auto
        px-3 sm:px-5 xl:px-30  w-full flex flex-col place-items-center gap-[27px] my-14 md:gap-[150px] lg:gap-[150px] lg:my-[81px] xl:gap-[120px] 2xl:gap-[150px] xl:mb-30">
