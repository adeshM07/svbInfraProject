          ...
          <div className="w-full flex flex-col px-2 lg:px-0 gap-[27px] my-21 md:gap-[150px] lg:gap-[150px] place-items-center">
            ...
            <div className="mx-2 md:mx-0 py-5 md:py-0 px-4 md:px-0 xl:w-[90vw] 2xl:w-[78vw] lg:w-[78vw] h-fit lg:h-[59vh] flex flex-col md:flex-col lg:flex-row gap-7 lg:gap-[20px] rounded-lg justify-center">
              <div>
                <img
                  src={ic1}
                  className="w-[85vw] [@media(min-width:650px)_and_(max-width:1200px)]:h-[60vh] h-[30vh] md:w-[85vw] md:h-[34vh] lg:w-[40vw] lg:h-[52vh] 2xl:h-[52vh]"
                  alt="Commitment to health & safety"
                />
              </div>

              <div className="flex flex-col gap-[10px] lg:gap-[20px]">
                <p className="text-[#FDC000] [@media(min-width:300px)_and_(max-width:410px)]:text-[1.2rem] text-[1.4rem] md:text-[2rem] lg:text-[2rem] fontMon font-semibold">
            ...
            <div className="mx-2 md:mx-0 py-5 md:py-0 px-4 md:px-0 xl:w-[90vw] 2xl:w-[78vw] lg:w-[78vw] h-fit lg:h-[59vh] flex flex-col lg:flex-row-reverse gap-7 lg:gap-[39px] rounded-lg justify-center">
              <div>
                <img
                  src={ic2}
                  className="w-[85vw] [@media(min-width:650px)_and_(max-width:1200px)]:h-[60vh] h-[30vh] md:w-[85vw] md:h-[34vh] lg:w-[60vw] lg:h-[52vh]"
                  alt="Land Leveling & Compaction"
                />
              </div>
              ...
              <div className="flex flex-col gap-[10px] lg:gap-[20px]">
                ...
                <ul className="text-[#333333] popins text-[14px] md:text-[15px] lg:text-[18px] lg:-mr-22 bg-white pl-7 lg:pl-12 font-semibold flex flex-col gap-[12px] py-2 rounded-xl lg:gap-[15px] shadow-[0_0_20px_rgba(0,0,0,0.5)] z-300">
                  ...
                  <li className="HSEUL">
                    Uses rollers, graders, and compactors to achieve required
                    soil density.
                  </li>
                  <li className="HSEUL">
          ...
          <div className=" w-full flex flex-col px-2 lg:px-0  gap-[27px] my-21 md:gap-[150px] lg:gap-[150px]  place-items-center">
            <div className="mx-2 md:mx-0 py-5 md:py-0 px-4 md:px-0 xl:w-[90vw] 2xl:w-[78vw] lg:w-[78vw] h-fit lg:h-[59vh] flex flex-col md:flex-col lg:flex-row gap-7 lg:gap-[20px] rounded-lg justify-center">
              ...
              >
                <img
                  src={ic1}
                  className="w-[85vw] [@media(min-width:650px)_and_(max-width:1200px)]:h-[60vh] h-[30vh] md:w-[85vw] md:h-[34vh] lg:w-[40vw] lg:h-[52vh] xl:h-[70vh] 2xl:h-[52vh]"
                  alt="Commitment to health & safety"
                />
              </motion.div>
            ...
            <div className="mx-2 md:mx-0 py-5 md:py-0 px-4 md:px-0 xl:w-[90vw] 2xl:w-[78vw] lg:w-[78vw] h-fit lg:h-[59vh] flex flex-col lg:flex-row-reverse gap-7 lg:gap-[39px] rounded-lg justify-center">
              ...
              >
                <img
                  src={ic2}
                  className="w-[85vw] [@media(min-width:650px)_and_(max-width:1200px)]:h-[60vh] h-[30vh] md:w-[85vw] md:h-[34vh] lg:w-[60vw] lg:h-[52vh] xl:h-[70vh] 2xl:h-[52vh]"
                  alt="Commitment to health & safety"
                />
              </motion.div>
