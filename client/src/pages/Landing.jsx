  ...
  ${applyEffect ? "banner-active" : ""}`}
        ...
        >
          <div>
            ...
            {/* === COUNTER BOXES === */}
            <motion.div
              className="flex gap-3 md:gap-5 [@media(min-width:300px)_and_(max-width:410px)]:my-6 my-10  mx-auto lg:mx-0 lg:my-2 pl-[3vw] [@media(min-width:900px)_and_(max-width:1200px)]:pl-10  md:pl-34"
