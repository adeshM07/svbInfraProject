      ...
      >
        <div>
          <section className="flex flex-row w-full px-4 lg:mx-0  lg:justify-center text-gray-800 ">
            ...
            >
              <p className="fontMon bg-[#F8F8F8]  absolute top-[5%] left-[5%] lg:leading-20 text-[1.5rem] xl:text-[3.5rem] 2xl:text-[4rem] md:text-[2rem] leading-7 md:leading-10 lg:py-0 lg:px-2 rounded-bl-2xl -ml-20 p-2 lg:-ml-56  text-[#333333] lg:text-[4rem] font-semibold">
                Great Relationships,
                <br /> Great
