      ...
      >
        ...
        >
          ...
          <Link to="/fleet" className="block z-400">
            <motion.button
              className="w-[30vw] md:w-[25vw] [@media(min-width:1280px)_and_(max-width:1500px)]:w-[34vw] [@media(min-width:1280px)_and_(max-width:1500px)]:h-[7vh] xl:w-[15vw] 2xl:w-[10vw] 2xl:h-[7vh]  lg:w-[10vw] lg:h-[7vh] z-999 rounded-md [@media(min-width:1280px)_and_(max-width:1500px)]:text-[9px] text-[0.7rem] px-3 lg:px-0 lg:py-0 py-2 bg-[#FDC000] lg:rounded-md md:text-[1.3rem] lg:text-[20px] popins-noweight font-semibold mt-[2.5rem]"
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
      ...
      >
          ...
          <section className="flex flex-row w-full px-4 lg:mx-0  lg:justify-center text-gray-800 ">
            ...
            >
              <video
                ...
                loop
                playsInline
                className="rounded-2xl shadow-lg w-[50vw] h-[32vh] lg:w-[40vw] xl:w-[45vw] xl:h-[90vh] lg:h-[84vh] 2xl:w-[40vw] 2xl:h-[84vh] object-cover"
              />
            </motion.div>
        ...
        <div className="pl-4 md:pl-34">
          ...
          <div className=" flex w-full py-2 lg:py-6 relative ">
            ...
            <div className="absolute   left-[68vw] md:left-[50.2vw] lg:left-[54.2vw] -top-[6vw]  md:-top-[6vw] lg:-top-[7vw] lg:w-[37vw] py-2 lg:py-4  overflow-hidden ">
