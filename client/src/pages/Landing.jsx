...
const Landing = () => {
  ...
  return (
    <>
      ...
      <div className=" bg-transparent ">
        ...
        <div
          // id="landingBanner"
          className={`w-screen  [@media(min-width:720px)_and_(max-width:1200px)]:h-[94vh]  h-[75vh] md:h-[45vh] lg:h-[88vh] transition-all duration-700 
  ${applyEffect ? "banner-active" : ""}`}
        ...
        <div
          id="secondSection"
          className="flex flex-col [@media(min-width:720px)_and_(max-width:1200px)]:gap-[30vh]   gap-[10vh] md:gap-[5vh] lg:gap-[7.6rem] pt-[10vh] md:pt-150vh]  py-15 lg:pb-30   bg-[#F8F8F8]"
        >
          <div>
            <section className="flex flex-row w-full px-4 lg:mx-0  lg:justify-center text-gray-800 ">
              ...
              >
                <video
                  ...
                  loop
                  playsInline
                  className="rounded-2xl shadow-lg [@media(min-width:720px)_and_(max-width:1200px)]:h-[95vh] w-[50vw] h-[32vh] lg:w-[40vw] xl:w-[45vw] xl:h-[90vh] lg:h-[84vh] 2xl:w-[40vw] 2xl:h-[84vh] object-cover"
                />
              </motion.div>
            ...
            {/* === COUNTER BOXES === */}
            <motion.div
              className="flex gap-3 md:gap-5 [@media(min-width:300px)_and_(max-width:410px)]:my-6 my-10  mx-auto lg:mx-0 lg:my-2 pl-[3vw] [@media(min-width:720px)_and_(max-width:1200px)]:pl-10  md:pl-34"
            ...
            >
              {/* Box 1 */}
              <div className="border [@media(min-width:300px)_and_(max-width:410px)]:w-[30vw] [@media(min-width:720px)_and_(max-width:1200px)]:h-[15vh] [@media(min-width:300px)_and_(max-width:410px)]:h-[6vh] lg:border-2 border-[#FDC000] rounded-md flex lg:w-[12vw] w-[27vw] xl:w-[15vw] 2xl:w-[12vw] justify-evenly h-[5vh] lg:h-[11vh] place-items-center">
              ...
              {/* Box 2 */}
              <div className="border [@media(min-width:720px)_and_(max-width:1200px)]:h-[15vh] [@media(min-width:300px)_and_(max-width:410px)]:w-[30vw] [@media(min-width:300px)_and_(max-width:410px)]:h-[6vh] lg:border-2 border-[#FDC000] rounded-md flex lg:w-[12vw] w-[27vw] xl:w-[15vw] 2xl:w-[12vw] justify-evenly h-[5vh] lg:h-[11vh] place-items-center">
                <p className="popins text-lg [@media(min-width:300px)_and_(max-width:410px)]:text-[0.9rem] md:text-[1.5rem] lg:text-3xl font-semibold">
                ...
                <div className="flex  animate-fleet-scroll gap-10 will-change-transform">
                  {[
                    ...
                    <img
                      key={i}
                      src={src}
                      className="[@media(min-width:720px)_and_(max-width:1200px)]:h-[40vh] [@media(min-width:720px)_and_(max-width:1200px)]:w-[55vh] lg:w-[18vw] lg:h-[43vh] md:w-[46vw] md:h-[20vh] w-[46vw] h-[20vh] object-cover"
                      loading="lazy"
                    />
                  ))}
                  {[
                    ...
                    <img
                      key={i + 10}
                      src={src}
                      className="[@media(min-width:720px)_and_(max-width:1200px)]:h-[40vh] [@media(min-width:720px)_and_(max-width:1200px)]:w-[55vh] lg:w-[18vw] lg:h-[43vh] w-[46vw] h-[20vh] object-cover"
                      loading="lazy"
                    />
                  ))}
                </div>
          ...
          <div className="pl-4 md:pl-34">
            ...
            <div className=" flex w-full py-2 lg:py-6 relative ">
              {isMobile ? (
                ...
                <p className="text-[#4D4D4D] popins [@media(min-width:720px)_and_(max-width:1200px)]:text-[0.9rem]  text-[0.6rem] lg:text-[1.5rem] lg:mt-3 font-semibold ">
              ...
              <div className="absolute [@media(min-width:720px)_and_(max-width:1200px)]:left-[55vw] [@media(min-width:720px)_and_(max-width:1200px)]:w-[25vw]   left-[68vw] md:left-[50.2vw] lg:left-[54.2vw] -top-[6vw]  md:-top-[6vw] lg:-top-[7vw] lg:w-[37vw] py-2 lg:py-4  overflow-hidden ">
                <div className="flex lg:gap-x-6 gap-x-2 animate-fleet-scroll ">
                  {[
                    ...
                    <img
                      ...
                      alt=""
                      className="[@media(min-width:720px)_and_(max-width:1200px)]:w-[30vw] [@media(min-width:720px)_and_(max-width:1200px)]:h-[20vh] w-[17vw] h-[10vh] lg:w-[20vw] lg:h-[47vh] object-cover 
          ...
          <div
            id="landing-contact"
            className="lg:w-[78vw] [@media(min-width:720px)_and_(max-width:1200px)]:h-[30vh]  rounded-md  w-[95vw] px-3 lg:px-0  text-white md:h-[23vh] lg:h-[37vh]  mx-auto flex  place-items-center justify-evenly gap-4 md:gap-[4.2rem] lg:gap-70 z-200"
          >
            <div className="">
            ...
            <Link to="/contact">
              <motion.button
                className="lg:w-[calc(9vw+0px)] [@media(min-width:720px)_and_(max-width:1200px)]:h-[10vh] md:w-[18vw] w-[calc(17vw+0px)] 
